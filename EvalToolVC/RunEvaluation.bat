...
%evaltool% -resultsDir "%resultsroot%\JODS" -datasetDir "%datasetroot%\JODS" -mode evaluation
%evaltool% -resultsDir "%resultsroot%\PASCAL" -datasetDir "%datasetroot%\PASCAL" -mode evaluation
